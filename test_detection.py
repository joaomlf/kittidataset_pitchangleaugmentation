...
def predictions_to_kitti_format(img_detections, calib, img_shape_2d, img_size, RGB_Map=None):
    predictions = np.zeros([100, 7], dtype=np.float32)
    count = 0
...
if __name__ == "__main__":
    ...
    for index, (img_paths, bev_maps) in enumerate(tqdm.tqdm(data_loader, desc="Detecting objects")):
        # Configure bev image
