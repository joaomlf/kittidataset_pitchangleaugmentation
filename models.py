...
class YOLOLayer(nn.Module):
    ...
    def forward(self, x, targets=None, img_dim=None):
        ...
        #     if pred_cls.size()[0] == 0: # True Negative
        #         print("True Negative")
        #         # return output, 0
        #         return output
        #     else: # False Positive
        ...
        #         return output
        #
        # elif pred_cls.size()[0] == 0: # False Negative
        ...
        if targets is None: # mode 'EVAL' doesn't input targets, but only imgs
            return output, 0
            ...
            total_loss = loss_x + loss_y + loss_w + loss_h + loss_euler + loss_conf + loss_cls
